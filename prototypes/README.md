...
| Prototype | Language | Notes |
|---|---|---|
| [`rust_ink_counter/`](./rust_ink_counter/) | Rust + ink! | Minimal Substrate / ink! smart contract: a value with `increment` / `decrement` / `get`. Demonstrates a basic ink! contract skeleton; intentionally not feature-complete. |
